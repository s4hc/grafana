...
function (Settings) {
  ...
  return new Settings({
    ...
    //elasticsearch: "http://"+window.location.hostname+":8080/elasticsearch",
     ...
     */
    //graphiteUrl: "http://107.20.238.69:8080",
    //graphiteUrl: "http://"+window.location.hostname+":8080/graphite",
    //graphiteUrl: "http://192.168.56.101/",
